...
//   - Official daily address at 17:50 (35 min)
...
const SCHED_LINES = [
  "Official address: 17:50. Sharp. Like Nattoun's teeth.",
...
export default function Stream() {
  ...
  const sendMessage = async (e: React.FormEvent) => {
    ...
    if (result.ok) {
      ...
      setChatError("Message rejected. Suspicious activity logged.");
    }
  };
                  ...
                  <h2 className="text-primary font-black uppercase text-base md:text-lg tracking-wider truncate">
                    {status.live && status.current
                      ? status.current.kind === "official"
                        ? `${status.current.label} — DAILY 17:50`
