...
export const HINTS: HintEntry[] = [
  ...
  { id: "rhythmmaster",  name: "Rhythm Master",    emoji: "🎸", difficulty: "hard", hint: "Beat level 50 of the rhythm game in Anthem Hall (/anthem). This is in the SynthMetal tier — fast notes, hold notes, symbol notes. Aim for 55%+ hit rate." },
  ...
  { id: "rhythmgod",    name: "Rhythm God",           emoji: "👑", difficulty: "insane", hint: "Beat level 100 of the rhythm game inside Anthem Hall (/anthem). You are in the Final Boss tier: 200 BPM, blast beats, hold notes, symbol notes, all 4 lanes firing. Hit 70%+ of notes to pass. Good luck." },
